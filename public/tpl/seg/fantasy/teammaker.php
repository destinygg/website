...
<div class="team-maker" data-settings="<?=Tpl::out(json_encode(Config::$a['fantasy']['team']))?>" style="display: none;">
	...
	<div class="team-maker-currency" style="text-align: center;">
		<span title="Available credits">
			<i class="icon-money"></i><strong class="credits">0</strong> <span>Credits</span>
		</span>
		<span title="Available transfers">
			<i class="icon-transfers"></i><strong class="transfers">0</strong> <span>Transfers</span>
		</span>
	</div>
	...
	<div class="team-maker-help">
		<p>
			To <strong>remove</strong> a champion from your team, click on the
			portrait in the team bar above.<br /> To <strong>add</strong> a
			champion to your team, click on the portait in the champion grid
			above the team bar.
		</p>
	</div>

	<div class="team-maker-tools">
		<button class="btn-confirm btn btn-primary" title="Confirm update">
			<i class="icon-ok icon-white"></i> Update
		</button>
		<button class="btn-close btn" title="Close window">
