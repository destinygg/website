		...
		<div id="summoner-<?=$summoner['summonerId']?>"
			...
			<div class="summoner-rank-info ranked pull-right">
				...
				<div class="pull-left summon-rank-stats">
					...
					<div>
						<span data-placement="left" data-toggle="tooltip" title="Previous day position <?=$summoner['league']['previousDayLeaguePosition']?>">Position <i class="icon-arrow-<?=(($positionOffset > 0) ? 'down':'up')?> icon-white"></i></span>
				...
				<div class="pull-left summon-rank-display">
					...
					<div class="summoner-rank-thumbnail pull-left">
						<i data-placement="left" data-toggle="tooltip" title="<?=$summoner['league']['tier']?> <?=$summoner['league']['rank']?>" style="width:45px; height:45px; background: url(<?=Config::cdn()?>/web/img/lol/rank/<?=strtolower($summoner['league']['tier'])?>_<?=$summoner['league']['rankInt']?>.png) no-repeat center center; background-size: 60px 60px;"></i>
					</div>
				</div>
			</div>
