    ...
    <div id="page-content" class="container clearfix">
        ...
        <div id="stream-panel">
            ...
            <div id="stream-wrap">
                ...
                <iframe class="stream-element" marginheight="0" marginwidth="0" frameborder="0" src="http://player.twitch.tv/?channel=<?=Config::$a['twitch']['user']?>" scrolling="no" seamless></iframe>
            </div>
