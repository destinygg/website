...
<body id="bigscreen" class="thin" style="overflow: hidden;">
  <div class="page-wrap clearfix">
    ...
    <div id="page-content" class="container clearfix" style="padding:0;">
          ...
          <div class="panelheader clearfix">
            <div class="toolgroup clearfix">
              <div class="pull-left channel-stat game">
                ...
                <?php else: ?>
                <span class="glyphicon glyphicon-time"></span> <span>Started <?=Date::getElapsedTime(Date::getDateTime($model->streamInfo['stream']['channel']['updated_at']))?></span>
