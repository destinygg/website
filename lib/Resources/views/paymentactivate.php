				...
				<form action="/payment/activate" method="post">
					...
					<div class="control-group">
						...
						<dl class="dl-horizontal">
							...
							<dd><?=Tpl::moment(Date::getDateTime($model->paymentProfile['billingStartDate']), Date::STRING_FORMAT_YEAR)?></dd>
							<?php if($model->paymentProfile['billingNextDate'] != $model->paymentProfile['billingStartDate']): ?>
							<dt>Billing next date:</dt>
							<dd><?=Tpl::moment(Date::getDateTime($model->paymentProfile['billingNextDate']), Date::STRING_FORMAT_YEAR)?></dd>
							<?php endif; ?>
						</dl>
