...
<section class="container" id="scheduleCalendarTimezone">
	<div class="content clearfix">
		<div style="padding:15px; margin:0;">
			<div><strong>Note!</strong> The calendar is showing times with a time zone offset of UTC 
			<button title="Change" class="btn btn-mini btn-primary timezone">UTC</button></div>
