...
<div class="content content-dark clearfix">
	<div class="stream clearfix" style="width:33.33333%;">
		<h3 class="title" style="border-bottom: none;">Points <small class="subtle">(per game)</small></h3>
	...
	<div class="stream clearfix" style="width:33.33333%;">
		<h3 class="title" style="border-bottom: none;">Limits  <small class="subtle">(per team)</small></h3>
		<ul style="padding:10px 20px 20px; margin:0; list-style: none;">
	...
	<div class="stream clearfix" style="width:33.33333%;">
		...
		<ul style="padding:10px 20px 20px; margin:0; list-style: none;">
			...
			<li>Free champions are rotated every <?=(Config::$a['fantasy']['intervals']['freechamp']/60/60/24)?> day(s)</li>
	...
	<div class="stream clearfix" style="width:33.33333%;">
		...
		<br />Score * (1 - ((X/Y) * (Z/X))).<br />
		X = Total games played by champion<br/>
		Y = Most played games by a single champion<br />
		Z = Total games won by champion
		</p>
	</div>
	<div class="stream clearfix" style="width:33.33333%;">
		...
		<ul style="padding:10px 20px 20px; margin:0; list-style: none;">
			...
			<li>Only champions which are picked <strong>before</strong> live games begin earn points</li>
		</ul>
	</div>
	<div class="stream clearfix" style="width:33.33333%;">
