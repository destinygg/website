	...
	<div class="content content-dark stream-grids clearfix">
		<div class="stream stream-grid">
			<table class="grid" style="width:100%;">
				...
				<tbody>
					<?$leaderboard = Service\Fantasy\Cache::getInstance()->getTeamLeaderboard(null, 10)?>
					...
					<?endforeach;?>
					<?for($s=0;$s<10-count($leaderboard);$s++):?>
					<tr>
		...
		<div class="stream stream-grid">
			<table class="grid" style="width:100%;">
				...
				<tbody>
					<?$gameLeaders = Service\Fantasy\Cache::getInstance()->getRecentGameLeaderboard(null, 10);?>
