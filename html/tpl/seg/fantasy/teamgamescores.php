...
$games = Service\Fantasy\Cache::getInstance()->getRecentGames (array('limit'=>3));
?>
<?if(!empty($games) && count($games) >= 3):?>
<?$userScores = \Destiny\Service\Fantasy\Db\Game::getInstance()->getTeamGameChampionsScores ($games, Session::$team['teamId']);?>
<div class="content content-dark clearfix">
	...
	<?foreach($games as $game):?>
		...
		<div class="game clearfix pull-left" data-gameId="<?=$game['gameId']?>" style="width:33.3333333%;">
			<div class="clearfix">
				<div class="game-champions clearfix">
					...
					<div class="game-team game-team1 game-team-win pull-left" style="width:50%;">
						...
						<div class="game-champion clearfix">
							...
							<div class="summoner-detail">
								<div class="name"><a class="subtle-link" title="<?=Tpl::out($champ1['summonerName'])?>" href="http://www.lolking.net/summoner/<?=$game['gameRegion']?>/<?=(int) $champ1['summonerId']?>"><?=Tpl::out($champ1['summonerName'])?></a></div>
					...
					<div class="game-team game-team2 game-team-lose pull-left" style="width:50%;">
						...
						<div class="game-champion clearfix">
							...
							<div class="summoner-detail">
								<div class="name"><a class="subtle-link" title="<?=Tpl::out($champ2['summonerName'])?>" href="http://www.lolking.net/summoner/<?=$game['gameRegion']?>/<?=(int) $champ2['summonerId']?>"><?=Tpl::out($champ2['summonerName'])?></a></div>
				...
				?>
				<small>
					<time class="pull-left" data-moment="true"><?=Date::getDateTime($game['gameCreatedDate'], Date::FORMAT)?></time>
	...
	<div id="checkRecentGamesSection">
		<p style="text-align: center; margin:20px 0;">
			<button class="btn btn-inverse" href="#checkRecentGames" data-lastcheck="<?=date(Date::FORMAT)?>"><i class="icon-refresh icon-white"></i> Check for new games</button>
		</p>
	</div>
