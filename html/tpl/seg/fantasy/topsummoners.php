				...
				<tr data-teamid="<?=$gameTeam['teamId']?>">
					...
					<td style="text-align: right;">
						...
						<?foreach($weekChampions as $weekChampion):?>
							<div class="thumbnail">
								<img title="<?=Tpl::out($weekChampion['championName'])?>"
									style="width: 25px; height: 25px;"
									src="<?=Config::cdn()?>/img/64x64.gif"
									data-src="<?=Lol::getIcon($weekChampion['championName'])?>" />
							</div>
						<?endforeach;?>
			...
			<tbody>
				...
				<tr>
					<td style="text-align: left;"><a
						href="http://www.lolking.net/summoner/na/<?=$summoner['summonerId']?>"
						class="subtle-link"> <img
							title="<?=Tpl::out($champ['championName'])?>"
							style="width: 20px; height: 20px;"
							src="<?=Config::cdn()?>/img/64x64.gif"
							data-src="<?=Lol::getIcon($champ['championName'])?>" />
						<?=$title?>
					</a></td>
					<td style="text-align: right;">
						<div>
