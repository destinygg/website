			...
			<div class="clearfix">
				<div style="width: 40%; float: left;">
					<div class="donate-block" id="paypal-donation">
						<p><a title="Visit www.paypal.com" href="https://www.paypal.com/">PayPal</a> contributions are welcome and appreciated, but not required.</p>
						<div id="paypal-form">
							<form action="https://www.paypal.com/cgi-bin/webscr" method="post" disabled="disabled">
								...
								<input type="hidden" name="lc" value="US"> <input type="hidden" name="item_name" value="<?=Config::$a['paypal']['name']?>"> 
