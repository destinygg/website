...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @namespace Chart
	 */
	var Chart = __webpack_require__(329)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    var moment = __webpack_require__(1);
	    var Chart = __webpack_require__(309);
	    ...
	    $('#graph4').each(function () {
	        ...
	        title.on('click', '.fa-arrow-left', function () {
	        ...
	        var updateGraph = function updateGraph(selectedDate) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    GraphUtil.fillGraphDates = function fillGraphDates(data, property, timeRange, timeUnit, format1, format2, addon) {
	        ...
	        for (var i = 0; i < data.length; ++i) {
	            var x = dates.indexOf(data[i].date);
	            if (x != -1) dataSet[x] = data[i][property];
	        }
	        return {
	            labels: dataLabels,
	            data: dataSet
	...
	(function () {
	    ...
	    $('#userlist').each(function () {
	        ...
	        usrlist.on('gridupdate', function () {
	            window.location.href = '/admin/users/?' + 'size=' + encodeURIComponent(size) + '&page=' + encodeURIComponent(page) + '&feature=' + encodeURIComponent(feature) + '&search=' + encodeURIComponent(search);
	        });
